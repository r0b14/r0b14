...
% Foto de perfil: [lado]{arquivo} — quadrado com cantos arredondados (5px = 1.3mm)
\newcommand{\raiofoto}{1.3mm}
\newcommand{\fotoperfil}[2][2.6cm]{%
  \begin{tikzpicture}
    \begin{scope}
      \clip[rounded corners=\raiofoto] (-#1/2,-#1/2) rectangle (#1/2,#1/2);
      \node[inner sep=0pt] at (0,0) {\includegraphics[width=#1]{#2}};
    \end{scope}
    \draw[primary, line width=0.5pt, rounded corners=\raiofoto]
...
\begin{minipage}[c]{2.6cm}
  \fotoperfil[2.5cm]{profile-eu.jpg}
\end{minipage}%
\hfill
