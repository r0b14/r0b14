...
\begin{center}
  ...
  {\large Estudante de Engenharia da Computação (UFPE) \textbar{} Desenvolvedor \& Automação de Processos}\\[5pt]
  \small
  Recife -- PE \textbar{}
...
Estudante de Engenharia da Computação na UFPE (conclusão em dez/2027), com atuação profissional em desenvolvimento
...
\skillline{Interesses técnicos}{Internet das Coisas (IoT) com ESP32, redes intraveiculares, inovação aplicada ao cotidiano}
...
\cargo{Desenvolvedor Front-End}{V-Lab UFPE}{Atual --- 1 ano e 5 meses}
\begin{itemize}
...
\vspace{2pt}
Cursando --- atende ao pré-requisito de estar a partir do 4º período.
...
\begin{itemize}
  ...
  \item \textbf{Anjos da Noite} (2021--2022) e \textbf{Programa Compaixão / ONG O Portal} (2024--2025) --- distribuição de alimentos e roupas a pessoas em situação de rua no Recife.
\end{itemize}
